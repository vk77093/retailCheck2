...
<div class="row">
    <div class="col-sm-4 text-center">
        <h4 class="text-center font-weight-bold mb-4">Tandori Sandwich Spread</h4>
<div class="img hvr-float"><img src="/productImage/Tandoori Sandwich.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
<button onclick="document.getElementById('myImage').src='/productImage/Tandoori Sandwich.jpg'">Close The packet</button>
...
<div class="text-center mr-5 ml-5">
    <h6 class="text-bold">DISCOVER THE TANDOORI SANDWICH SPREAD</h6>
</div>
<div class="container mt-3">
    <div class="row w-70">
        <div class="col-sm-4">
<div class="img hvr-float-shadow"><img src="/image/tandoriSandwich.jpg" class="img-fluid center-block" alt="Responsive image"></div>
        </div>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
             <td>2</td>
            <td>Foodcoast tandoori sandwich spread</td>
            <td>40 gm</td>
        </tr>
        <tr>
             <td>3</td>
...
<ul class="list-item ml-5 cook-text">
    <li>Heat 1tbsp. oil in a pan, add all the chopped vegetables and sauté  for 2-3 min.</li>
    <li>Add 1 tbsp. Foodcoast Tandoori sandwich spread and amul cheese to the pan.</li>
    <li>Spread the mixture on two slices of bread & club each of them with another slice.</li>
    <li>Serve grilled for better taste!!!!</li>
</ul>
<div class="text-center">
    <p class="font-weight-bold tagLine"><i>Enjoy your delicious & healthy Tandoori Mayo Sandwich !!</i></p>
</div>
</div>
