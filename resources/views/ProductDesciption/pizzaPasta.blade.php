...
<div class="row">
    <div class="col-sm-4 text-center">
        <h4 class="text-center font-weight-bold mb-4">Pizza Pasta Sauce</h4>
<div class="img hvr-float"><img src="/productImage/pizza pasta sauce.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
<button onclick="document.getElementById('myImage').src='/productImage/pizza pasta sauce.jpg'">Close The packet</button>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingOne1">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="false"
        ...
        <h5 class="mb-0">
         Composition and nutritional value <i class="fa fa-angle-down float-right rotate"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingTwo2">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
        ...
        <h5 class="mb-0">
        Storage conditions and shelf life <i class="fa fa-angle-down rotate float-right"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree3">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
        ...
        <h5 class="mb-0">
        Weight and packaging format<i class="fa fa-angle-down rotate float-right"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree4">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
        ...
        <h5 class="mb-0">
        Box / Pallet<i class="fa fa-angle-down fa-flip-both rotate float-right"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree5">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
        ...
        <h5 class="mb-0">
        Product code<i class="fa fa-angle-down rotate float-right"></i>
        </h5>
      </a>
    </div>
...
<div class="text-center mr-5 ml-5">
    <h6 class="text-bold">DISCOVER THE RED PASTA SAUCE</h6>
</div>
<div class="container mt-3">
    <div class="row w-70">
        <div class="col-sm-4">
<div class="img hvr-float-shadow"><img src="/image/redPastaSauce.jpg" class="img-fluid center-block" alt="Responsive image"></div>
        </div>
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>Pasta (fusilli/penne)</td>
            <td>50 gm</td>
        </tr>
        <tr>
             <td>2</td>
            <td>small onion and capsicum(finally chopped)</td>
            <td>1 Pcs</td>
        </tr>
        <tr>
             <td>3</td>
        ...
        <tr>
             <td>4</td>
            <td>Foodcoast red pasta sauce </td>
            <td>50 gm</td>
        </tr>
        <tr>
             <td>5</td>
        ...
        <tr>
             <td>7</td>
            <td>Amul processed cheese or fresh parsley</td>
            <td>20 gm</td>
        </tr>
        <tr>
             <td>8</td>
...
<ul class="list-item ml-5 cook-text">
    <li>Boil the pasta (fusilli/penne) in 1L water with a pinch of salt on medium flame & then drain the extra water over a colander.</li>
    <li>In another pan, heat 2 tbsp. oil, add garlic, chopped vegetables & sauté for few seconds.</li>
    <li>Add the cooked pasta, Red pasta sauce and water to it  & mix it well until the sauce coats the pasta evenly.</li>
    <li>Serve the pasta garnished with amul processed cheese & fresh parsley.</li>
</ul>
<div class="text-center">
    <p class="font-weight-bold tagLine"><i>Savour the authentic Italian taste of rich,hot & spicy pasta at home!!</i></p>
</div>
</div>
