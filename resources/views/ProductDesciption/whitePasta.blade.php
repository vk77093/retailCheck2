...
<div class="row">
    <div class="col-sm-4 text-center">
        <h4 class="text-center font-weight-bold mb-4">White Pasta Sauce</h4>
<div class="img hvr-float"><img src="/productImage/white pasta sauce.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
<button onclick="document.getElementById('myImage').src='/productImage/white pasta sauce.jpg'">Close The packet</button>
...
<div class="text-center mr-5 ml-5">
    <h6 class="text-bold">DISCOVER THE WHITE PASTA SAUCE</h6>
</div>
<div class="container mt-3">
    <div class="row w-70">
        <div class="col-sm-4">
<div class="img hvr-float-shadow"><img src="/image/whitePasta.jpg" class="img-fluid center-block" alt="Responsive image"></div>
        </div>
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>Spaghetti or Penne Pasta</td>
            <td>60 gm</td>
        </tr>
        <tr>
             <td>2</td>
            <td>Small finely chopped onion and capsicum</td>
            <td>1 Pcs</td>
        </tr>
        <tr>
             <td>3</td>
        ...
        <tr>
             <td>5</td>
            <td>Foodcoast White pasta sauce</td>
            <td>50 gm</td>
        </tr>
        <tr>
             <td>6</td>
        ...
        <tr>
            <td>7</td>
            <td>parmesan cheese or basil, salt and pepper</td>
            <td>As Per Taste</td>
        </tr>
...
<ul class="list-item ml-5 cook-text">
    <li>Boil  Spaghetti or penne pasta in 1L water with a pinch of salt on medium flame & then drain the extra water over a colander</li>
    <li>Melt the butter in a large skillet over medium heat, add garlic and chopped vegetables and sauté   for few seconds.</li>
    <li>Add  Foodcoast White Pasta sauce into water, stir & cover it. After stirring well , add it into  the cooked pasta & mix it well</li>
    <li>Serve the pasta garnished with grated parmesan cheese & fresh parsley or basil.</li>
</ul>
<div class="text-center">
    <p class="font-weight-bold tagLine"><i>Enjoy the authentic taste of rich, creamy pasta at home !!</i></p>
</div>
</div>
...
<div class="col-sm-4">
<div class="img hvr-float-shadow"><a href="/butterMayo"><img src="/productImage/Buttery Mayo.jpg" class="img-fluid center-block" alt="Responsive image"></a></div>
