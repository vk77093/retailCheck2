...
<div class="row">
    <div class="col-sm-4 text-center">
        <h4 class="text-center font-weight-bold mb-4">Exotic Sandwich Spread</h4>
<div class="img hvr-float"><img src="/productImage/Exotic Sandwich.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
<button onclick="document.getElementById('myImage').src='/productImage/Exotic Sandwich.jpg'">Close The packet</button>
