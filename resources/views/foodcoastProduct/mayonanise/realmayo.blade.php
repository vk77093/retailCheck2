...
<div class="container pb-top">
    <div class="row">
        <div class="col-sm-4 text-center">
            <h4 class="text-center font-weight-bold mb-4">Real Mayo</h4>
            <div class="img hvr-float"><img src="/productImage/Real Mayonnaise.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
            {{-- <button onclick="document.getElementById('myImage').src='/productImage/closingPacket.gif'">Close The packet</button>
            <button onclick="document.getElementById('myImage').src='/productImage/openPacket.gif'">Open The Packet</button> --}}
        </div>
        <div class="col-sm-8">
            <div class="container my-4 ml-3">
                ...
                <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card">
                        ...
                        <!-- Card body -->
                        {{-- class="collapse show" --}}
                        <div id="collapseOne1" role="tabpanel" class="collapse show" aria-labelledby="headingOne1" data-parent="#accordionEx">
                            <div class="card-body">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-6">
...
{{-- <div class="text-center mr-5 ml-5">
    <h6 class="text-bold">DISCOVER THE Real MAYO</h6>
</div>
...
<div class="container w-50 mt-5">
    <div class="row justify-content-md-center">
        <div class="col-sm-4">
            <div class="img hvr-float-shadow"><a href="/butterMayo"><img src="/productImage/classic mayo.jpg" class="img-fluid center-block" alt="Responsive image"></a></div>
            <p class="text-center mt-2">Classic Mayo</p>
        </div>
        <div class="col-sm-4">
            <div class="img hvr-float-shadow"><a href="/sandwich"><img src="/productImage/Mayo_Lite.jpg" class="img-fluid center-block" alt="Responsive image"></a></div>
            <p class="text-center mt-2">Mayo Lite</p>
        </div>
        <div class="col-sm-4">
            <div class="img hvr-float-shadow"><a href="/pizzaPasta"><img src="/productImage/Mayo_Lite.jpg" class="img-fluid center-block" alt="Responsive image"></a></div>
            <p class="text-center mt-2">Tomato Cheesn Chilli Mayo</p>
        </div>
    </div>
</div>
