...
<div class="row">
    <div class="col-sm-4 text-center">
        <h4 class="text-center font-weight-bold mb-4">Burger Mayo</h4>
<div class="img hvr-float"><img src="/productImage/Burger Mayo.jpg" class="img-fluid center-block" alt="Responsive image" id="myImage"></div>
